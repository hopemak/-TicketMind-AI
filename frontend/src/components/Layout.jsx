...
const Layout = () => {
  ...
  const navItems = [
    ...
    { path: '/my-tickets', label: 'Tickets', icon: (
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* Sidebar */}
      <aside className={`fixed top-0 left-0 z-50 h-full w-64 bg-white border-r border-slate-200 transform transition-transform duration-200 lg:translate-x-0 ${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        {/* Logo */}
        <div className="h-16 flex items-center px-6 border-b border-slate-100">
          <Link to="/" className="flex items-center gap-3">
            ...
            <div>
              <span className="text-lg font-bold text-slate-900 tracking-tight">AI Support</span>
            </div>
          </Link>
        </div>
      ...
      <div className="lg:pl-64">
        {/* Top bar */}
        <header className="sticky top-0 z-30 h-16 bg-white/80 backdrop-blur border-b border-slate-200 flex items-center px-4 sm:px-8">
          <button
